...
with st.expander("ℹ️ - tentang web app ini", expanded=True):
     st.write(
        """     
-   *Evaluator Kompetisi Mega Perintis* adalah sebuah web application penilaian untuk karyawan Mega Perintis.
	    """
    )
st.markdown("")
...
############################
    ...
    with st.form('form_77'):
        ...
        # LOGIKA NYA 
        if b2 and korek_nik == search_1:
            st.write('Nama Yang akan di nilai **' + search_2 + '***')
            #save_data['Nama Yang Akan Dinilai'] = search_2
            #save_data['Note'] =  'Penilai ' + search_1 + ' Nama Yang akan di nilai ' + search_2
        else:
...
with c12:
    with st.form('form_3'):      
        ...
        #st.markdown('Note: yang di bawah ini adalah detail data hasil penilaian & data langsung tersimpan di database')
